    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex space-x-3">
           ...
           <button onClick={handleDownloadJSON} className="btn-primary flex items-center space-x-2">
           ...
           {[
             ...
             <React.Fragment key={i}>
                <div className="flex flex-col items-center group">
                   <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 mb-3 ${
                     step.active ? 'bg-primary text-white shadow-lg shadow-primary/30 scale-110' : 'bg-gray-50 text-gray-300'
                   }`}>
